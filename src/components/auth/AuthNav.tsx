...
import { HOME_PATH, PROJECTS_PATH, SIGN_IN_PATH, SIGN_UP_PATH, isAuthPath } from '@/lib/routes';
...
export default function AuthNav() {
  ...
  if (isAuthPath(pathname) || pathname === HOME_PATH || pathname === PROJECTS_PATH) return null;
