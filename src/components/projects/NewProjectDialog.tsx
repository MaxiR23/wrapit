...
export default function NewProjectDialog({
  ...
  async function onSubmit(values: ProjectInput) {
    ...
    if ('fieldErrors' in result) {
      ...
      if (fieldErrors.invitees) {
        setFormError(fieldErrors.invitees);
      }
      return;
    }
    ...
    setInviteNotice(
      result.inviteErrors && result.inviteErrors.length > 0
        ? `Couldn't invite one or more users. ${CANT_INVITE_USER_MESSAGE}. Invite them from Members on the project page.`
        : null,
    );
              ...
              <FieldGroup className="gap-[18px]">
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid} className="gap-[7px]">
                      ...
                      {fieldState.invalid && (
                        <FieldError
                          id="new-project-description-error"
                ...
                <Field className="gap-[7px]">
                  ...
                  <button
                    ...
                    className={cn(
                      shellFocusClassName,
                      'self-start text-[12.5px] font-medium text-muted-foreground hover:text-foreground',
                    )}
