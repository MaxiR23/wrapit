...
export default function ProjectsBrand({
  ...
  return (
    <div className={cn('flex items-center', compact ? 'justify-center' : 'gap-2.5 px-1.5')}>
      <span
        className={cn(
          'inline-flex shrink-0 items-center justify-center rounded-md bg-foreground font-semibold text-primary-foreground',
          compact ? 'size-[30px] text-sm' : 'size-[26px] text-[13px]',
        )}
      >
        w
      </span>
